...
```shell
mvn install:install-file -Dfile=/path/to/hbase-spark_3.0.2_2.12-1.2.0-cdh5.12.1.jar -DgroupId=org.apache.hbase -DartifactId=hbase-spark_3.0.2_2.12 -Dversion=1.2.0-cdh5.12.1 -Dpackaging=jar
```

### 1.2 hbase-client包

```shell
mvn install:install-file -Dfile=/path/to/hbase-client_3.0.2_2.12-1.2.0-cdh5.12.1.jar -DgroupId=org.apache.hbase -DartifactId=hbase-client_3.0.2_2.12 -Dversion=1.2.0-cdh5.12.1 -Dpackaging=jar
```
