...
public class ZtoScanSend extends HBaseBaseBean<ZtoScanSend> {
    ...
    public ZtoScanSend buildRowKey() {
        this.rowKey = SparkUtils.appendString(StringUtils.reverse(this.bill_code), "0", 16) + DateFormatUtils.oggDateSchemaFormat(this.scan_date, "yyyyMMddHHmmss") + this.scan_site_id;
        return this;
    }
}
