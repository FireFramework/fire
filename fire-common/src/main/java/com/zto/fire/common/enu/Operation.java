...
public enum Operation {
    ...
    ENABLE_TABLE(28), DISABLE_TABLE(29), DELETE(30), DELETE_FAMILY(31), DELETE_QUALIFIER(32), UPDATE(33), UPSERT(34), MERGE(35), CREATE_VIEW_AS_SELECT(36), REPLACE_INTO(37), UNKNOWN(404);
