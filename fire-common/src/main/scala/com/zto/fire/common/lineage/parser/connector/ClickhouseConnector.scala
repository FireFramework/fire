 ...
 * @since 2.3.8
 */
private[fire] object ClickhouseConnector extends IJDBCConnector {
  ...
  override def parse(tableIdentifier: TableIdentifier, properties: mutable.Map[String, String], partitions: String): Unit = {
    ...
    this.addDatasource(Datasource.CLICKHOUSE, url, physicalTable, username, Operation.CREATE_TABLE)
  }
}
