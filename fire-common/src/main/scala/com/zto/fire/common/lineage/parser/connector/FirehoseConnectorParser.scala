...
/**
 * Firehose Connector血缘解析器
 *
 * @author ChengLong 2023-08-24 14:04:38
 * @since 2.3.8
 */
private[fire] object FirehoseConnectorParser extends IFileConnectorParser {
  ...
  override def parse(tableIdentifier: TableIdentifier, properties: Map[String, String]): Unit = {
    ...
    val tableName = properties.getOrElse("delivery-stream", "")
    SQLLineageManager.setPhysicalTable(tableIdentifier, tableName)

    this.addDatasource(Datasource.FIREHOSE, cluster,
      tableName,
