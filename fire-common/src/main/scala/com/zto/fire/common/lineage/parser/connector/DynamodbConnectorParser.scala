...
/**
 * Dynamodb Connector血缘解析器
 *
 * @author ChengLong 2023-08-24 14:05:25
 * @since 2.3.8
 */
private[fire] object DynamodbConnectorParser extends IFileConnectorParser {
  ...
  override def parse(tableIdentifier: TableIdentifier, properties: Map[String, String]): Unit = {
    ...
    this.addDatasource(Datasource.DYNAMODB, cluster,
      tableName,
