...
/**
 * Starrocks Connector血缘解析器
 *
 * @author ChengLong 2023-12-11 15:00:02
 * @since 2.4.2
 */
private[fire] object StarrocksConnectorParser extends IJDBCConnectorParser {
  ...
  override def parse(tableIdentifier: TableIdentifier, properties: Map[String, String]): Unit = {
    ...
    val url = properties.getOrElse("jdbc-url", properties.getOrElse("scan-url", ""))
